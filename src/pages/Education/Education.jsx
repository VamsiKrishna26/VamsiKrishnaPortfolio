...
const Education = (props) => {
    ...
    const list1 = ["University of Leicester", "MSc in Advanced Computer Science.", "Overall 82% in taught modules. Currently doing my project/dissertation.", "Studying modules like Advanced Web Technologies, Mobile and Web Applications, Big Data, and Predictive Analysis."]
